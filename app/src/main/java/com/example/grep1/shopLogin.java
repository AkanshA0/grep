...
public class shopLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intentNavDraw=new Intent(getApplicationContext(),shopNavDrawAct.class);
    ...
    public void onClickLogin(View view)
    {
        ...
        if(idEditText.getText().toString().contains("@") && idEditText.getText().toString().length() > 5 && passwordEditText.getText().toString().length() > 5) {
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(shopLogin.this, "Authentication failed.",Toast.LENGTH_SHORT).show();
                                // updateUI(null);
                            }
            ...
            Toast.makeText(shopLogin.this, "INVALID USERNAME OR PASSWORD !",
